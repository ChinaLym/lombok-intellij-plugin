...
public class DelombokLoggerAction extends AbstractDelombokAction {
  ...
  protected DelombokHandler createHandler() {
    return new DelombokHandler(
      ...
      ServiceManager.getService(SLogProcessor.class), ServiceManager.getService(Slf4jProcessor.class), ServiceManager.getService(XSlf4jProcessor.class), ServiceManager.getService(FloggerProcessor.class),
