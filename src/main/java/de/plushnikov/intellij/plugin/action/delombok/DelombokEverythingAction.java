...
public class DelombokEverythingAction extends AbstractDelombokAction {
  ...
  protected DelombokHandler createHandler() {
    return new DelombokHandler(true,
      ...
      ServiceManager.getService(SLogProcessor.class), ServiceManager.getService(Log4j2Processor.class), ServiceManager.getService(LogProcessor.class), ServiceManager.getService(Slf4jProcessor.class),
